...
CREATE TABLE `t_department`  (
  ...
  `description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '部门简介',
...
CREATE TABLE `t_employee`  (
  ...
  `work_place` set('北京','深圳','上海','武汉','成都','西安') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '北京' COMMENT '工作地点',
