...
class Department(Base):
    ...
    employees = relationship(argument="Employee", back_populates="department", lazy="selectin")
...
class Employee(Base):
    ...
    department = relationship(argument="Department", back_populates="employees", lazy="joined")

    job = relationship(argument="Job", backref="employees", lazy="joined")
